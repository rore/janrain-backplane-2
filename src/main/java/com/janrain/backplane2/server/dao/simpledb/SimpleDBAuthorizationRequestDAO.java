 ...
 * @author Johnny Bufu
 */
public class SimpleDBAuthorizationRequestDAO implements AuthorizationRequestDAO {

    SimpleDBAuthorizationRequestDAO(SuperSimpleDB superSimpleDB, Backplane2Config bpConfig) {
    ...
    private static final Logger logger = Logger.getLogger(SimpleDBAuthorizationRequestDAO.class);
