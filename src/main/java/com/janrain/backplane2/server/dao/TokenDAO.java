...
public class TokenDAO extends DAO<Token> {
    ...
    private final com.yammer.metrics.core.Timer v2persistTokenTimer = Metrics.newTimer(TokenDAO.class, "v2_sdb_persist_token", TimeUnit.MILLISECONDS, TimeUnit.MINUTES);
